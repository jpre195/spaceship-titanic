...
product = {
    "nb": "C:\\Users\\kaitr\\Documents\\GitHub\\spaceship-titanic\\products\\random_forest_model.ipynb",
    "model": "C:\\Users\\kaitr\\Documents\\GitHub\\spaceship-titanic\\products\\random_forest\\model.pkl",
    "confusion": "C:\\Users\\kaitr\\Documents\\GitHub\\spaceship-titanic\\products\\random_forest\\confusion.png",
    "confusion_test": "C:\\Users\\kaitr\\Documents\\GitHub\\spaceship-titanic\\products\\random_forest\\confusion_test.png",
    "pr_curve": "C:\\Users\\kaitr\\Documents\\GitHub\\spaceship-titanic\\products\\random_forest\\pr_curve.png",
}
...
def objective(trial, X, y):
    ...
    params = {'n_estimators' : trial.suggest_int('n_estimators', 10, 100, 10),
              'criterion' : trial.suggest_categorical('criterion', ['gini', 'entropy', 'log_loss']),
              'max_features' : trial.suggest_categorical('max_features', ['sqrt', 'log2', None])}

    model = RandomForestClassifier(max_depth = 5, class_weight = 'balanced', **params)
    pipe = Pipeline([('scaler', StandardScaler()),
                    ('model', CalibratedClassifierCV(model, method = 'isotonic', cv = 3))])
    
    pipe.fit(X, y)

    preds_ = pipe.predict(X)

    f1 = f1_score(y, preds_)
...
model = RandomForestClassifier(max_depth = 5, class_weight = 'balanced', **best_params)
pipe = Pipeline([('scaler', StandardScaler()),
                 ('model', CalibratedClassifierCV(model, method = 'isotonic', cv = 3))])
